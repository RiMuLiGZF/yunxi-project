...
代理路径映射：
  M8 /api/study-plan/*  →  M4 /api/v1/study-plan/*
...
@router.get("/health", summary=f"学业规划服务状态（M4代理）")
async def study_plan_health(
    ...
    try:
        ...
        return ApiResponse.success(data={
            ...
            "target_prefix": "/api/v1/study-plan",
    ...
    try:
        ...
        return ApiResponse.success(data={
            **status,
            "service": "study_plan",
            "service_name": "学业规划",
            "m8_prefix": "/api/study-plan",
            "m4_prefix": "/api/v1/study-plan",
