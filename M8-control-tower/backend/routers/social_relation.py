...
代理路径映射：
  M8 /api/social-relation/*  →  M4 /api/v1/social-relation/*
...
@router.get("/health", summary=f"人际关系服务状态（M4代理）")
async def social_relation_health(
    ...
    try:
        ...
        return ApiResponse.success(data={
            "status": "proxied",
            "service": "social_relation",
            "service_name": "人际关系",
            "target_module": "m4",
            "target_base_url": M4_BASE_URL,
            "target_prefix": "/api/v1/social-relation",
    ...
    try:
        ...
        return ApiResponse.success(data={
            **status,
            "service": "social_relation",
            "service_name": "人际关系",
            "m8_prefix": "/api/social-relation",
            "m4_prefix": "/api/v1/social-relation",
