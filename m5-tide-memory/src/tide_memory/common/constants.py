...
ENCRYPTION_ALGORITHM = DEFAULT_ENCRYPTION_ALGORITHM  # 别名
...
# 密级保留期别名
RETENTION_TOP_SECRET_DAYS = CLASSIFICATION_TOP_SECRET_DAYS
RETENTION_CONFIDENTIAL_DAYS = CLASSIFICATION_CONFIDENTIAL_DAYS
RETENTION_INTERNAL_DAYS = CLASSIFICATION_INTERNAL_DAYS
RETENTION_PUBLIC_DAYS = CLASSIFICATION_PUBLIC_DAYS
RETENTION_FOREVER = CLASSIFICATION_PUBLIC_DAYS  # 永久保留标记值
...
SQLITE_TIMEOUT = SQLITE_BUSY_TIMEOUT    # SQLite 超时别名
...
CLASSIFICATION_DEFAULT = DEFAULT_CLASSIFICATION  # 别名
...
SERVICE_NAME = MODULE_NAME             # 服务名称（别名）
SERVICE_VERSION = MODULE_VERSION       # 服务版本（别名）
