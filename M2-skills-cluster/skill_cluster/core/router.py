...
from skill_cluster.core.middleware import MiddlewarePipeline
...
class SkillRouter:
    ...
    def __init__(
        ...
        if self._idempotency_config.enabled:
            ...
            from skill_cluster.core.middleware import idempotent_middleware
