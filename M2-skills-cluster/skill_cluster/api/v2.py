...
def create_v2_app(
    ...
    # ---- M8 Token 鉴权中间件 ----
    from skill_cluster.api.middleware.m8_auth import M8TokenAuthMiddleware, get_admin_token_from_env
    ...
    # ---- 测试管理路由 ----
    from skill_cluster.api.test_endpoints import TestManager, register_test_routes

    test_manager = TestManager()
    register_test_routes(app, test_manager)

    # ---- MCP 传输层端点 ----
    from skill_cluster.extensions.mcp.transport import MCPTransport
