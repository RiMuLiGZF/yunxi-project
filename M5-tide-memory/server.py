...
def _get_m5_real_metrics():
    ...
    try:
        ...
        # 遍历各层数据库统计条目数和存储空间
        layers = [
            ("l1_shallow", cfg.get("memory.layers.l1_shallow.db_path", "./data/memory/l1_shallow.db")),
            ("l2_deep", cfg.get("memory.layers.l2_deep.db_path", "./data/memory/l2_deep.db")),
            ("l3_abyss", os.path.join(cfg.get("storage.l3_path", "./data/memory/abyss"), "index.db")),
        ]
        ...
        # 向量维度
        vector_dim = cfg.get("vector.dimension", 1536)
